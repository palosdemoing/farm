...
public class ProductionController implements CRUD<ProductionDTO, Integer> {
	...
	public ProductionDTO create(@RequestBody ProductionDTO t) throws NotFound {
	...
	public void delete(@RequestBody ProductionDTO t, @PathParam("id") Integer id) throws CannotProceed {
	...
	public ProductionDTO update(@RequestBody ProductionDTO t, @PathParam("id") Integer id) throws CannotProceed, NotFound {
	...
	public List<ProductionDTO> getAll(Pageable pageable) throws NotFound{
